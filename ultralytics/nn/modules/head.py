...
class v10OBB(OBB):
    """
    v10 OBB detection head from https://arxiv.org/pdf/2405.14458
    ...
    Methods:
        __init__(self, nc=80, ne=1, ch=()): Initializes the v10OBB object.
        forward(self, x): Performs forward pass of the v10OBB module.
        bias_init(self): Initializes biases of the Detect module.
    ...
    def __init__(self, nc=80, ne=1, ch=()):
        """Initializes the v10OBB object with the specified number of classes, extra parameters, and input channels."""
        super().__init__(nc, ne, ch)
        c4 = max(ch[0] // 4, self.ne)  # channels
        # Light cls head
        self.cv4 = nn.ModuleList(
            nn.Sequential(
                nn.Sequential(Conv(x, x, 3, g=x), Conv(x, c4, 1)),
                nn.Sequential(Conv(c4, c4, 3, g=c4), Conv(c4, c4, 1)),
